...
//        (no-arg constructor). The second constructor has parameters
//        width and height of type double and it needs to initialize the fields.
//        In case the width is less than 0 it needs to set the width field value to 0,
//        in case the height parameter is less than 0 it needs to set
...
//        it needs to set the value of the width field. If the parameter is
//        less than 0 it needs to set the width field value to 0.
//
//        Method named setHeight with one parameter of type double,
//        it needs to set the value of the height field. If the parameter
//        is less than 0 it needs to set the height field value to 0.
//
//        Method named getArea without any parameters, it needs
//        to return the area of the wall.
