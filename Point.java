...
//        Write a class with the name Point. The class needs
...
//        The second constructor has parameters x and y of type int and it
//        needs to initialize the fields.
//
//        Write the following methods (instance methods):
//
//        Method named getX without any parameters,
//        it needs to return the value of x field.
//
//        Method named getY without any parameters,
//        it needs to return the value of y field.
//
//        Method named setX with one parameter of type int,
//        it needs to set the value of the x field.
//
//        Method named setY with one parameter of type int,
//        it needs to set the value of the y field.
//
